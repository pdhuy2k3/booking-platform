    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
      <Card className="hover:shadow-lg transition-shadow cursor-pointer group" onClick={() => onStartBooking("flight")}>
        ...
        <CardContent className="text-center">
          <p className="text-muted-foreground mb-4">Tìm và đặt vé đến điểm đến của bạn cùng trợ lý thông minh.</p>
          <Button className="w-full bg-primary hover:bg-primary/90">Bắt đầu tìm chuyến bay</Button>
        </CardContent>
      </Card>
      ...
      <Card className="hover:shadow-lg transition-shadow cursor-pointer group" onClick={() => onStartBooking("hotel")}>
        <CardHeader className="text-center">
          ...
          <CardTitle>Đặt khách sạn</CardTitle>
        </CardHeader>
        <CardContent className="text-center">
          <p className="text-muted-foreground mb-4">Khám phá và đặt nơi lưu trú phù hợp cho kỳ nghỉ của bạn.</p>
          <Button className="w-full bg-secondary hover:bg-secondary/90">Bắt đầu tìm khách sạn</Button>
        </CardContent>
      </Card>
      ...
      <Card className="hover:shadow-lg transition-shadow cursor-pointer group" onClick={() => onStartBooking("both")}>
        <CardHeader className="text-center">
          ...
          <CardTitle>Gói trọn chuyến</CardTitle>
        </CardHeader>
        <CardContent className="text-center">
          <p className="text-muted-foreground mb-4">Lên kế hoạch toàn bộ chuyến đi với vé máy bay và khách sạn trong một lần đặt.</p>
          <Button className="w-full bg-accent hover:bg-accent/90">Đặt gói trọn gói</Button>
        </CardContent>
      </Card>
    </div>
  )
