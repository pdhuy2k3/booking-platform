...
export function BookingSmartLogo(props: SVGProps<SVGSVGElement>) {
  return (
    <div className="flex justify-center items-center">
      ...
      >
        ...
        <g fill="none" stroke="hsl(var(--bs-primary))" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2">
