...
BEGIN
    ...
    LOOP
        ...
        FOR i IN 1..flights_per_route LOOP
            ...
            -- Insert flight schedule with proper enum status and aircraft
            INSERT INTO flight_schedules (
                schedule_id, flight_id, departure_time, arrival_time, 
                aircraft_id, aircraft_type, status, created_at, created_by, updated_at, updated_by, is_deleted
            ) VALUES (
                new_schedule_id,
