...
-- Add event_id column to flight_outbox_events
...
ALTER TABLE flight_outbox_events
    ADD CONSTRAINT uk_flight_outbox_event_id UNIQUE (event_id);

-- changeset PhamDuyHuy:1752800000006-5
-- Create index for event_id
CREATE INDEX idx_flight_outbox_event_id ON flight_outbox_events (event_id);
